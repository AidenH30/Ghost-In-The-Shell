...
<form action="../app/controllers/processa_registrar_caso.php" method="POST" enctype="multipart/form-data" class="container mt-4 p-4 border rounded shadow bg-light">
